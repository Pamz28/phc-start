...
require 'connect.php';
	...
	if($_REQUEST["ItemCode"] != ""){
		...
		header('location:ฺDispenseQty.php');
	}
	...
	$xCusFullName =$_SESSION["CusFullName"];
		...
		$Sql .= "INNER  item_category_main ON item_category_main.CategoryMain_Code = item_category.CategoryMain_Code ";
...
<body>
	...
	<form action="DispenserPriceSale.php" method="post">
		<div class="row xTop1">
			<div class="col">
 ...
 <?php 	for($j=0;$j<$i;$j++){ ?>               
                  <tr>
                    <th><?php echo $j+1 ?></th>
                    <td><a href="DispenserQty.php?ItemCode=<?php echo $Item_Code[$j] ?>&Price=<?php echo $xPrice[$j] ?>"><?php echo $NameTH[$j] ?></a></td>
